...
// students arrayinda grade-i 100 və ya 95-ə bərabər olan tələbələrin
// adlarını yeni arrayə əlavə edib, yeni
// yaranmış arrayi consolda yazdırın;
...
// let myArray=students.filter(x=>x.grade==100 || x.grade==95)
...
// Verilmiş arrayda customerId dəyəri ERNSH olan sifarişlərin sayını tapın.

// let newArrUzunlugu=orders.filter(x=>x.customerId=="ERNSH").length
// console.log(newArrUzunlugu);

// Verilmiş array-i employeeId-ə görə sortlayın.
// newMarket.sort((a,b) => a.employeedId - b.employeedId)
// console.log(newMarket);

// Verilmiş arrayda Order Detailsi dəyəri 3-dən çox olanları console-a yazdırın.
let myDetails=order.filter(x=>x.details?.length>3);
...
order.sort((a,b) => b.employeedId - a.employeedId)
// Verilmiş arrayda customerId dəyəri ERNSH olan sifarişlərin sayını tapın.
// let ernshOlanlar = order.filter((x) => x.customerId === "ERNSH");
// console.log(ernshOlanlar.length);
...
// let abc = newArr.filter(x => x.details?.length > 3);
// console.log(abc);

// // Verilmiş arrayda freight 1 dən kiçik olan sifarişləri yeni arraya elave edib console-a yazdırın.

// let result = newArr.filter((item) => item.freight < 1);
// console.log(result);
